...
describe('OtpDockClient', () => {
    let client;
    beforeEach(() => {
        client = new index_1.OtpDockClient('test-api-key');
    });
    describe('constructor', () => {
        it('should create instance with api key', () => {
            expect(client).toBeInstanceOf(index_1.OtpDockClient);
        });
        it('should throw error if api key is not provided', () => {
            expect(() => new index_1.OtpDockClient('')).toThrow('API key is required');
        });
    });
    describe('getOtp', () => {
        ...
        it('should extract OTP from various email formats', async () => {
            for (const email of commonOtpEmails) {
                ...
                const client = new index_1.OtpDockClient('test-api-key');
        ...
        it('should handle various OTP formats', async () => {
            const otpVariations = [
                ...
                { body: 'OTP: A1B2C3', expected: 'A1B2C3' },
        ...
        it('should use default values for optional parameters', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(expect.stringContaining('test123'), expect.any(Object));
        });
